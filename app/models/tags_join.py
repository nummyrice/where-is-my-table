...
reservation_tags = db.Table('reservation_tags',
    ...
    db.Column('created_at', db.DateTime(timezone=True), nullable=False, server_default=func.now()),
    db.Column('updated_at', db.DateTime(timezone=True), onupdate=func.now(), default=func.now())
)
